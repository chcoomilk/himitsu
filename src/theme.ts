...
export const applyTheme = (theme: AppThemeSetting) => {
    ...
    switch (theme) {
        case AppThemeSetting.Normal:
            ...
            css.setProperty("--himitsu-input-border", increase_brightness(base_bg_color, 11));
            css.setProperty("--himitsu-input-disabled-bg", increase_brightness_linear(base_bg_color, -2));
            css.setProperty("--himitsu-input-disabled-border", increase_brightness_linear(base_bg_color, -2));
